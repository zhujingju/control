...
public class LaserScanLayer extends SubscriberLayer<sensor_msgs.LaserScan> implements TfLayer {
  ...
  private static final String TAG = "Print-Laser";
  private static final Color FREE_SPACE_COLOR = Color.fromHexAndAlpha("ff5913", 0.1f); // 377dfa
  private static final Color OCCUPIED_SPACE_COLOR = Color.fromHexAndAlpha("ff5913", 0.3f); // 377dfa
...
//    for(FlagBean flag : flagBeanList){
//      if(flag.getShape() != null){// && flag.isReady()
//        flag.getShape().draw(view, gl); // gl null
//      }
//    }
  }
...
//        Log.i(TAG, "onNewMessage: laserScan is " + laserScan);
