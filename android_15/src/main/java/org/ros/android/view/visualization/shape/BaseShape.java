...
public abstract class BaseShape implements Shape {
  ...
  public void draw(VisualizationView view, GL10 gl) {
    ...
    scale(view, gl); // PixelSpacePoseShape.scale, package org.ros.android.view.visualization.shape;
    drawShape(view, gl); // TriangleFanShape.drawShape, package org.ros.android.view.visualization.shape;
    gl.glPopMatrix();
  }
