...
public class Vertices {
  ...
  /** 画圆形 */
  public static void drawCircle(GL10 gl, FloatBuffer vertices, Color color, float width) {
    vertices.mark();
    color.apply(gl);
    gl.glLineWidth(width);
    gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
...
//    gl.glDrawArrays(GL10.GL_LINE_LOOP, 0, countVertices(vertices, 3));
    gl.glDrawArrays(GL10.GL_LINE_STRIP, 0, countVertices(vertices, 2));
    gl.glDisableClientState(GL10.GL_VERTEX_ARRAY);
    vertices.reset();
  }
  /** 画实心圆 */
  public static void drawSolidRound(GL10 gl, FloatBuffer vertices, Color color, float width) {
    vertices.mark();
    color.apply(gl);
    gl.glLineWidth(width);
    gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
//    gl.glVertexPointer(3, GL10.GL_FLOAT, 0, vertices);
    gl.glVertexPointer(2, GL10.GL_FLOAT, 0, vertices);
//    gl.glDrawArrays(GL10.GL_LINE_LOOP, 0, countVertices(vertices, 3));
    gl.glDrawArrays(GL10.GL_LINE_LOOP, 0, countVertices(vertices, 2));
    gl.glDisableClientState(GL10.GL_VERTEX_ARRAY);
    vertices.reset();
  }
