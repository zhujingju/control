...
public class XYOrthographicCamera {
  private final String TAG = "Print-Camera";
  /**
   ...
   * cm on the display.
   */
//  private static final double PIXELS_PER_METER = 100.0; // 原
  private static final double PIXELS_PER_METER = 150.0; // 投放到屏幕的显示比例。sxg
  ...
  public void setFrame(String frame) {
    Log.i(TAG, "setFrame: frame="+frame);
