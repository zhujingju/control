...
public class OpenGlTransform {
  ...
  public static void apply(GL10 gl, Transform transform) {
    ...
    /** 用实际数据算出的一个transform.toMatrix()
     * new double[]{
     2.127969143751681,  -0.673626,  0,  0.0D,

     0.673626,  2.127969143751681,  0,  0.0D,

     0,  0,  0.444567529,  0.0D,

     10.1362944,  9.5696173011968,  0.010,  1.0D
