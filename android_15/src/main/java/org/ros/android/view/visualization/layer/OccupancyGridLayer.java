 ...
 */
public class OccupancyGridLayer extends SubscriberLayer<nav_msgs.OccupancyGrid> implements TfLayer { // sxg: outOfMemoryError
  ...
  private class Tile {
    ...
    private final TextureBitmap textureBitmap = new TextureBitmap(); // sxg: outOfMemoryError
  ...
  public void onStart(VisualizationView view, ConnectedNode connectedNode) {
    ...
    previousGl = null;
    getSubscriber().addMessageListener(new MessageListener<nav_msgs.OccupancyGrid>() { // sxg: outOfMemoryError
      @Override
      public void onNewMessage(nav_msgs.OccupancyGrid message) {
        update(message); // sxg: outOfMemoryError
      }
    });
  }
  ...
  private void update(nav_msgs.OccupancyGrid message) {
    ...
    while (tiles.size() < numTiles) {
      tiles.add(new Tile(resolution)); // sxg: outOfMemoryError
    }
