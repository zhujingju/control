...
public class MasterNameResolver extends AbstractNodeMain {
	...
	public void onStart(final ConnectedNode connectedNode) {
        Preconditions.checkArgument(!initialized, "Remocon masterNameResolver already initialized");
        ...
        initialized = true;
//        Log.i(TAG, "Remocon masterNameResolver initialized");
	}

    @Override
    public void onShutdown(Node node) {
        Preconditions.checkArgument(initialized, "Remocon masterNameResolver not initialized");
