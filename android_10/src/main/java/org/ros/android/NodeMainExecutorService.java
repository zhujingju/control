...
//        builder.setMessage("Continue shutting down?");
        builder.setMessage(R.string.s_exitApp);
//        builder.setPositiveButton("Shutdown", new OnClickListener() {
        builder.setPositiveButton(R.string.s_exit, new OnClickListener() {
          @Override
...
//        builder.setNegativeButton("Cancel", new OnClickListener() {
        builder.setNegativeButton(R.string.s_exitCancel, new OnClickListener() {
          @Override
          public void onClick(DialogInterface dialog, int which) {
          }
        });
...
//      notification.setLatestEventInfo(this, intent.getStringExtra(EXTRA_NOTIFICATION_TITLE),
//          getString(R.string.s_TapToShutdown), pendingIntent);
      Notification noti = new Notification.Builder(this)
              .setContentTitle(intent.getStringExtra(EXTRA_NOTIFICATION_TITLE))
              .setContentText(getString(R.string.s_TapToShutdown))
...
//      startForeground(ONGOING_NOTIFICATION, notification);
  ...
  public void toast(final int strId) {
    handler.post(new Runnable() {
      @Override
      public void run() {
        Toast.makeText(NodeMainExecutorService.this, strId, Toast.LENGTH_SHORT).show();
      }
    });
  }
}
