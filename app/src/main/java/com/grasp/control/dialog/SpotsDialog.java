...
public class SpotsDialog extends AlertDialog {
    ...
    public void setStrText(String s){
    ...
    private void initProgress() {
        ...
        int size = getContext().getResources().getDimensionPixelSize(R.dimen.dip_5_0);
        int progressWidth = getContext().getResources().getDimensionPixelSize(R.dimen.dip_250_0);
